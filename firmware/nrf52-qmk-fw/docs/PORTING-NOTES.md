...
**기본값 2분.** 길어도 거의 공짜다 — RGB 65mA × 4분 = 4.3mAh = 1000mAh 의 **0.4%**. 진짜 절감은
그 뒤 계속 꺼져 있는 데서 나온다. VIA(FEATURE > POWER > Idle Timeout)로 Off~4분 조절 가능하고,
**Off 를 고르면 ZMK 와 같은 동작**이 된다.
